...
{
    ui->setupUi(this);
    ui->stackedWidget->setSizePolicy(QSizePolicy::Expanding,
    ...
    connect(ui->host_btn, &QPushButton::clicked, this,
            &Game::on_host_btn_pressed);
    connect(ui->join_btn, &QPushButton::clicked, this,
            &Game::on_join_btn_pressed);
    connect(ui->start_game, &QPushButton::clicked, this,
            &Game::on_start_game_pressed);
    // from page
    connect(ui->host_cancel, &QPushButton::clicked, this,
            &Game::on_host_cancel_pressed);
    connect(ui->join_cancel, &QPushButton::clicked, this,
            &Game::on_join_cancel_pressedd);
    // from wait
    connect(ui->cancel_host, &QPushButton::clicked, this,
            &Game::on_cancel_host_pressed);
    connect(ui->cancel_join, &QPushButton::clicked, this,
            &Game::on_cancel_join_pressed);
}
